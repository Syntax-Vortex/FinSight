...
export default function Transactions({setActivePanel}) {
    ...
    return (
        <div className="w-full h-auto flex-1 bg-white border-2 border-gray-200 rounded-xl hover:scale-[1.01] duration-150 flex px-4
                        py-2 flex-col justify-around items-center">
            <div className="flex justify-end items-center w-full">
                <p className="font-semibold text-xl ml-auto">Biggest Expenses for the month</p>
                <button className="ml-auto text-blue-400 hover:underline cursor-pointer" onClick={() => {setActivePanel(1)}}>View All</button>
            </div>
