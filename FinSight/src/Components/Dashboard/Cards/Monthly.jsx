export default function Monthly(props) {
    ...
    return (
        <div className="w-[320px] h-37.5 border-2 border-gray-200 rounded-xl bg-white py-4 px-6 flex flex-col gap-4 justify-start items-start
            ...
            <p className="text-green-400 bg-green-100 px-1 rounded-sm mt-auto text-sm">{percent}% vs last month</p>
        </div>
    )
}